...
public class CategoryService {
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public CategoryResponse update(Long categoryId, CategoryRequest request, MultipartFile image)
            throws IOException {
        ...
        if (image != null && !image.isEmpty() && category.getImage() != null && !category.getImage().isEmpty()) {
            imageUtilities.deleteFile("category",

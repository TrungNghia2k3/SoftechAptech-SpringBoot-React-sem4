...
import com.devteria.identityservice.utilities.EmailUtilities;
import com.devteria.identityservice.utilities.OtpUtilities;
...
public class UserService {
    ...
    public UserResponse getMyInfo() {
        ...
        userResponse.setNoPassword(!StringUtils.hasText(user.getPassword())); // Returns information about whether the user has a password?
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public PageResponse<UserResponse> getAllPaginationSortUsers(int page, int size, String sortBy, String sortDirection) {

...
public class CategoryController {
    ...
    public ApiResponse<PageResponse<CategoryResponse>> getAllPaginationSortCategories(
        ...
        return ApiResponse.<PageResponse<CategoryResponse>>builder().result(categories).build();
    }
    ...
    public ApiResponse<CategoryResponse> toggleDisabledCategory(@PathVariable Long id) {
        return ApiResponse.<CategoryResponse>builder().result(categoryService.toggleDisabled(id)).build();
    }

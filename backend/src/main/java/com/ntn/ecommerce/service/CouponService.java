...
import com.ntn.ecommerce.constant.CouponType;
...
import com.ntn.ecommerce.mapper.CouponMapper;
import com.ntn.ecommerce.mapper.UserCouponsMapper;
import com.ntn.ecommerce.repository.CouponRepository;
import com.ntn.ecommerce.repository.UserCouponsRepository;
...
public class CouponService {
    ...
    public CouponResponse getCoupon(String id) {
        return couponMapper.toCouponResponse(
                couponRepository.findById(id).orElseThrow(() -> new AppException(ErrorCode.COUPON_NOT_FOUND)));
    }
    ...
    public UserCouponsResponse redeemCoupon(String couponId, String userId) {
        ...
        Coupon coupon =
                couponRepository.findById(couponId).orElseThrow(() -> new AppException(ErrorCode.COUPON_NOT_FOUND));
        ...
        UserCoupons userCoupon =
                userCouponsRepository.findByUserAndCoupon(user, coupon).orElse(null);

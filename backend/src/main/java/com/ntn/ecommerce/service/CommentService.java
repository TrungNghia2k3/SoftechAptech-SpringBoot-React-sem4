...
import com.ntn.ecommerce.mapper.CommentMapper;
import com.ntn.ecommerce.repository.CommentRepository;
...
public class CommentService {
    ...
    public CommentResponse addCommentAndRating(String userId, String productId, CommentRequest request) {
        ...
        Long commentCount =
                commentRepository.countCommentsByUserAndProductInDay(userId, productId, startOfDay, endOfDay);
        if (commentCount > 0) {

...
import com.ntn.ecommerce.service.ProductService;
...
public class ProductController {
    ...
    public ApiResponse<ProductResponse> createProduct(
        ...
        ProductResponse productResponse =
                productService.createProduct(request, imageMain, imageSubOne, imageSubTwo, audio);
    ...
    public ApiResponse<ProductResponse> updateProduct(
        ...
        ProductResponse productResponse =
                productService.updateProduct(id, request, imageMain, imageSubOne, imageSubTwo, audio);
    ...
    public ApiResponse<List<ProductResponse>> getAllProductsByCategoryId(@PathVariable Long categoryId) {
        return ApiResponse.<List<ProductResponse>>builder()
                .result(productService.getAllProductsByCategoryId(categoryId))
                .build();
    }
    ...
    public ApiResponse<PageResponse<ProductResponse>> filterProducts(
        ...
        Pageable pageable = PageRequest.of(
                page, size, asc ? Sort.by(sortBy).ascending() : Sort.by(sortBy).descending());
        PageResponse<ProductResponse> pageResponse =
                productService.filterProducts(categoryId, publisherId, formality, minPrice, maxPrice, title, pageable);
    ...
    public ApiResponse<List<ProductResponse>> getAllProductsByPublisherId(@PathVariable Long publisherId) {
        return ApiResponse.<List<ProductResponse>>builder()
                .result(productService.getAllProductsByPublisherId(publisherId))
                .build();
    }
    ...
    public ApiResponse<List<ProductResponse>> getAllProductsByAuthor(@PathVariable String authorName) {
        return ApiResponse.<List<ProductResponse>>builder()
                .result(productService.getAllProductsByAuthorName(authorName))
                .build();
    }

    @GetMapping("/rankingMostPopularProducts")
    public ApiResponse<List<ProductRankingResponse>> getRankingMostPopularProducts() {
        return ApiResponse.<List<ProductRankingResponse>>builder()
                .result(productService.getRankingMostPopularProducts())
                .build();
    }
    ...
    public ApiResponse<List<ProductResponse>> getAllProductsByManufactureId(@PathVariable Long manufactureId) {
        return ApiResponse.<List<ProductResponse>>builder()
                .result(manufactureProductsService.getAllProductsByManufactureId(manufactureId))
                .build();
    }
